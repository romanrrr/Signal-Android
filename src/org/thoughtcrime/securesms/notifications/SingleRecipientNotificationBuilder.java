...
public class SingleRecipientNotificationBuilder extends AbstractNotificationBuilder {
  ...
  public void setThread(@NonNull Recipient recipient) {
    ...
    if (privacy.isDisplayContact()) {
      ...
      setLargeIcon(new GeneratedContactPhoto("Unknown", R.drawable.outline_account_circle_24).asDrawable(context, ContactColors.UNKNOWN_COLOR.toConversationColor(context)));
    }
  }
