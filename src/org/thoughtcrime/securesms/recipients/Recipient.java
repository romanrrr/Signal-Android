...
public class Recipient implements RecipientModifiedListener {
    ...
    private @NonNull
    RegisteredState registered = RegisteredState.UNKNOWN;
    ...
    private @NonNull
    UnidentifiedAccessMode unidentifiedAccessMode = UnidentifiedAccessMode.DISABLED;
    ...
    public @NonNull
    synchronized List<Recipient> getParticipants() {
    ...
    ContactPhoto getContactPhoto() {
        ...
        else if (isGroupRecipient() && groupAvatarId != null)
